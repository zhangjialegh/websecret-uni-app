<template>
	<view class="picachu-container">
	    ...
	    <view class="mountain-range-mask"></view>
	  <view class="forest">
	  ...
	  <view class="sparkles">
	      <view class="sparkle one"></view>
	      <view class="sparkle one"></view>
	      <view class="sparkle one"></view>
	      <view class="sparkle one"></view>
	      <view class="sparkle two"></view>
	      <view class="sparkle two"></view>
	      <view class="sparkle two"></view>
	      <view class="sparkle two"></view>
	      <view class="sparkle three"></view>
	      <view class="sparkle three"></view>
	      <view class="sparkle three"></view>
	      <view class="sparkle three"></view>
	      <view class="sparkle four"></view>
	      <view class="sparkle four"></view>
	      <view class="sparkle four"></view>
	      <view class="sparkle four"></view>
	      <view class="sparkle five"></view>
	      <view class="sparkle five"></view>
	      <view class="sparkle five"></view>
	      <view class="sparkle five"></view>
	      <view class="sparkle six"></view>
	      <view class="sparkle six"></view>
	      <view class="sparkle six"></view>
	      <view class="sparkle six"></view>
	      <view class="sparkle seven"></view>
	      <view class="sparkle seven"></view>
	      <view class="sparkle seven"></view>
	      <view class="sparkle seven"></view>
	      <view class="sparkle eight"></view>
	      <view class="sparkle eight"></view>
	      <view class="sparkle eight"></view>
	      <view class="sparkle eight"></view>
	    </view>
	  <view class="grass">
	    <view class="pokemon">
	      <view class="poke bulbasaur">
	        <view class="ear"></view>
	        <view class="ear"></view>
	        <view class="head"></view>
	        <view class="leg"></view>
	        <view class="bulba-body"></view>
	        <view class="bulbs">
	          <view class="bulb"></view>
	        </view>
	      </view>
	      <view class="poke pikachu">
	        <view class="ear"></view>
	        <view class="ear"></view>
	        <view class="hand"></view>
	        <view class="pika-body"></view>
	        <view class="head"></view>
	        <view class="pika-tail"></view>
	      </view>
	    </view>
	  </view>
	</view>
